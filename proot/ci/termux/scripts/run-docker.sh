...
load_apparmor_profile "$TERMUX_SCRIPTDIR/scripts/profile-relaxed.apparmor"
...
load_apparmor_profile "$TERMUX_SCRIPTDIR/scripts/profile-restricted.apparmor" "Loading restricted AppArmor profile"
