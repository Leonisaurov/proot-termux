...
\tis occupied, proot will search for the next free port.",
        ...
        { .class = "Network policy options",
          ...
          .detail = "deny blocks by default; allow permits by default. Deny rules always win. With --control-fd, *, tcp://*, and udp://* only hand UNKNOWN destinations to PRCT; the harness must still allow them.",
        },
        { .class = "Network policy options",
          .arguments = {
